...
public class TestingLibrary {
	...
	public static void main(String[] args) throws IOException, InterruptedException
	{
		...
		sl.UnitOfMeasurement("h00h7;].p;gbghhj", "100fk[ljiuhujjo");
	...
	FileOutputStream fo=new FileOutputStream("D:\\Mishra1\\Stock Accounting Mishra\\src\\com\\Stockaccounting\\Results\\uomres1.xlsx");
		wb.write(fo);
		wb.close();
		*/
